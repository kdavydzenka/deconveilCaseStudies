...
cnv_filt <- apply(cnv_tumor_luad, 2, function(x) ifelse(x > 15, 15, x)) 
...
ggsave("deconveilCaseStudies/plots/main/boxplot_luad.png", dpi = 400, width = 5.0, height = 5.0, plot = bxp_t)
...
ggsave("deconveilCaseStudies/plots/main/boxplot_luad_tumVsNorm.png", dpi = 400, width = 5.0, height = 5.0, plot = bxp_all)


# Main figure 
s1_fig <- patchwork::wrap_plots(A=bxp_t, B=bxp_all)+
                      plot_annotation(tag_levels = "A")
ggsave("deconveilCaseStudies/plots/supplementary/Supplementyary_1.png", dpi = 400, width = 10.0, height = 6.0, plot = s1_fig)
