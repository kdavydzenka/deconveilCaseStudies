...
simulate_data <- function(n_samples, n_genes) {
  ...
  # Write to CSV
  write.csv(rna_join, file = paste0("deconveilCaseStudies/simulations/data/replicates/rna_join_", n_samples, "_", n_genes, ".csv"))
  write.csv(cn_join, file = paste0("deconveilCaseStudies/simulations/data/replicates/cn_join_", n_samples, "_", n_genes, ".csv"))
  write.csv(metadata, file = paste0("deconveilCaseStudies/simulations/data/replicates/metadata_", n_samples, "_", n_genes, ".csv"))
}
