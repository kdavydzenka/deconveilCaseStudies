...
simulate_data <- function(n_samples, n_genes) {
  ...
  rna_counts_sim <- compcodeR::generateSyntheticData(
    ...
    output.file = paste0("deconveilCaseStudies/simulations/results/replicates_rna_counts_sim/rna_counts_sim_", n_samples, "_", n_genes, "_brca.rds")
  )
  ...
  # Write to CSV
  write.csv(rna_join, file = paste0("deconveilCaseStudies/simulations/data/simulations_1/replicates/rna_join_", n_samples, "_", n_genes, ".csv"))
  write.csv(cn_join, file = paste0("deconveilCaseStudies/simulations/data/simulations_1/replicates/cn_join_", n_samples, "_", n_genes, ".csv"))
  write.csv(metadata, file = paste0("deconveilCaseStudies/simulations/data/simulations_1/replicates/metadata_", n_samples, "_", n_genes, ".csv"))
}
